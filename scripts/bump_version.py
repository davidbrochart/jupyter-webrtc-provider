...
def bump(force, skip_if_dirty, spec):
    ...
    # bump the required version in jupyter-webrtc-provider metapackage
    # to ensure that users can just upgrade `jupyter-webrtc-provider`
    ...
    metapackage = "jupyter-webrtc-provider"
